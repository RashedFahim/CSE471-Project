...
@section('title')
    {{ $property->property_name }} | RealEasy RealEstate  
@endsection
                    ...
                    <div class="author-box pull-left">
                        @if($property->agent_id == Null)
                            <figure class="author-thumb">
                                <img src="{{ url('upload/admin_images/202412311213anime-icon-18.jpg') }}" alt="">
                            </figure>
                            <h6>Admin</h6>
                        @else
                            <figure class="author-thumb">
                                <img src="{{ (!empty($property->user->photo)) ? url('upload/agent_images/'.$property->user->photo) : url('upload/no_image.jpg') }}" alt="">
                            </figure>
        ...
        <div class="author-widget sidebar-widget">
            <div class="author-box">
             ...
             @if($property->agent_id == Null)
              ...
              <figure class="author-thumb"><img src="{{ url('upload/admin_images/202412311213anime-icon-18.jpg') }}" alt=""></figure>
                <div class="inner">
                    <h4>Admin </h4>
                    <ul class="info clearfix">
